...
# Konsensus fra Investing.com / Zacks / Visible Alpha (manuelt verifisert)
# Revenue i milliarder USD
consensus_data = {
    "2025-04-29": {  # Q1 2025
        "quarter": "Q1 2025",
        "rev_actual": 29.40, "rev_cons": None,
        "verdict": "Sterk rapport, høye gasspriser",
    },
    "2025-07-22": {  # Q2 2025
        "quarter": "Q2 2025",
        "rev_actual": 25.14, "rev_cons": 24.06,
        "verdict": "Revenue beat, EPS slight miss",
    },
    "2025-10-28": {  # Q3 2025
        "quarter": "Q3 2025",
        "rev_actual": 26.00, "rev_cons": 24.30,
        "verdict": "Revenue beat, EPS miss (-34%)",
    },
    "2026-02-04": {  # Q4 2025
        "quarter": "Q4 2025",
        "rev_actual": 25.30, "rev_cons": 22.49,
        "verdict": "EPS beat (+33%), Revenue beat (+12%)",
    },
    "2025-02-05": {  # Q4 2024
        "quarter": "Q4 2024",
        "rev_actual": None, "rev_cons": None,
        "verdict": "EPS miss, Revenue beat",
    },
    "2024-10-24": {  # Q3 2024
        "quarter": "Q3 2024",
        "rev_actual": None, "rev_cons": None,
...
if rev_quarters:
    ...
    w = 0.35
    ax_rev.bar(x_pos - w/2, rev_actual, w, color="#3498db", alpha=0.8,
    ...
    for j, rc in enumerate(rev_cons):
        if rc is not None:
            ...
            ax_rev.annotate(f"{diff_pct:+.1f}%",
                           xy=(x_pos[j], max(rev_actual[j], rc) + 0.3),
    ...
    ax_rev.set_title("Omsetning: Faktisk vs. konsensusestimat (kilde: Investing.com / Zacks)", fontsize=11)

plt.subplots_adjust(top=0.95, bottom=0.06)
output_path = "/Users/emmastrandenskaar/Documents/Claude/Projects/Oljepris/data/equinor_post_earnings.png"
