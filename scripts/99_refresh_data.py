...
DATA_SOURCES = [
    ...
    {
        "name":        "brent",
        "description": "Brent spot- og forward-pris",
        "fetcher":     "02_fetch_brent.py",
        "outputs":     ["data/raw/brent_spot.csv"],
        "max_age_days": 7,
        "frequency":   "daily",
        "group":       "market",
    },
    {
        "name":        "global-prices",
        "description": "Globale crude-priser (WTI, Dubai, etc.)",
        "fetcher":     "23_fetch_global_prices.py",
        "outputs":     ["data/raw/global_crude_prices.csv"],
        "max_age_days": 7,
        "frequency":   "daily",
        "group":       "market",
    },
    {
        ...
        "outputs":     ["data/raw/market_controls.csv"],
        "max_age_days": 7,
        "frequency":   "daily",
        "group":       "market",
    },
    {
        ...
        "outputs":     ["data/raw/crack_spreads.csv"],
        "max_age_days": 14,
        "frequency":   "weekly",
        "group":       "market",
    },
    {
        ...
        "outputs":     ["data/raw/forward_curve.csv"],
        "max_age_days": 14,
        "frequency":   "weekly",
        "group":       "market",
    },
    ...
    },
    {
        ...
        "outputs":     ["data/raw/eia_imports/eia_imports_landed.csv"],
        "max_age_days": 30,
        "frequency":   "monthly",
        "group":       "fundamentals",
    },
    ...
    # ── ASSAY-DATABASER (operatørene oppdaterer årlig+) ──────────────────
    {
        ...
        "outputs":     ["data/raw/assays/equinor/"],
        "max_age_days": 365,
        "frequency":   "annual",
        "group":       "assays",
    },
    {
        ...
        "outputs":     ["data/raw/assays/exxonmobil/"],
        "max_age_days": 365,
        "frequency":   "annual",
        "group":       "assays",
    },
    {
        ...
        "outputs":     ["data/raw/assays/totalenergies/"],
        "max_age_days": 365,
        "frequency":   "annual",
        "group":       "assays",
    },
