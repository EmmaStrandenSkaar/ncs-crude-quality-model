...
SRC = Path(str(Path(__file__).resolve().parents[3] / "data" / "raw" / "sodir" / "sodir_wellbore_exploration_all.csv"))
OUT = Path(str(Path(__file__).resolve().parents[3] / "analyses" / "decline_quality" / "data" / "fluid_enrichment" / "field_exploration_summary.csv"))
